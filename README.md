...
```javascript
dssumpw = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dssumpw@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-dssumpw/tags). For example,

```javascript
dssumpw = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dssumpw@v0.3.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dssumpw = require( 'path/to/vendor/umd/blas-ext-base-dssumpw/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dssumpw@umd/browser.js"></script>
```
...
The `N` and stride parameters determine which elements in x are accessed at runtime. For example, to compute the sum of every other element:
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-dssumpw/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-dssumpw/actions/workflows/test.yml?query=branch:v0.3.1
...
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-dssumpw/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-dssumpw/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-dssumpw/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-dssumpw/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-dssumpw/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-dssumpw/blob/main/branches.md
